<template>
  <div class="container">
    <article class="helvetica">
      <header class="vh-100 bg-navy dt w-100 white">
        <div
          style="background:url(./bg.jpeg) no-repeat center right;background-size: cover;"
          class="dark-mask dtc v-mid cover ph3 ph4-m ph5-l"
        >
